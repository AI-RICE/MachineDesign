...
class Design2(Design):
    ...
    def set_oper_params(self):
        fr = 50  # [Hz]
        RotSpeed = 60 * fr / self.PolePairs  # [rpm]
        self.oper_params = {
            "Id1": "0.0A",
            "Iq1": "0.0A",
            "Id3": "0.0A",
    ...
    def set_output_vars(self):
        self.output_vars = {
            ...
            'dIA_dt': "-Im1*2*pi*fr*sin(2*pi*fr*Time+epsI1-pi) - Im3*6*pi*fr*sin(3*(2*pi*fr*Time)+epsI3-pi)",
            'dIB_dt': "-Im1*2*pi*fr*sin(2*pi*fr*Time-72deg+epsI1-pi) - Im3*6*pi*fr*sin(3*(2*pi*fr*Time-72deg)+epsI3-pi)",
            'dIC_dt': "-Im1*2*pi*fr*sin(2*pi*fr*Time-144deg+epsI1-pi) - Im3*6*pi*fr*sin(3*(2*pi*fr*Time-144deg)+epsI3-pi)",
            'dID_dt': "-Im1*2*pi*fr*sin(2*pi*fr*Time-216deg+epsI1-pi) - Im3*6*pi*fr*sin(3*(2*pi*fr*Time-216deg)+epsI3-pi)",
            'dIE_dt': "-Im1*2*pi*fr*sin(2*pi*fr*Time-288deg+epsI1-pi) - Im3*6*pi*fr*sin(3*(2*pi*fr*Time-288deg)+epsI3-pi)",
    ...
    def assign_stator_coils(self):
        ...
        # Excitations
        I_A = "Im1*cos(2*pi*fr*time+epsI1-pi) + Im3*cos(3*(2*pi*fr*time)+epsI3-pi)"
        I_B = "Im1*cos(2*pi*fr*time-72deg+epsI1-pi) + Im3*cos(3*(2*pi*fr*time-72deg)+epsI3-pi)"
        I_C = "Im1*cos(2*pi*fr*time-144deg+epsI1-pi) + Im3*cos(3*(2*pi*fr*time-144deg)+epsI3-pi)"
        I_D = "Im1*cos(2*pi*fr*time-216deg+epsI1-pi) + Im3*cos(3*(2*pi*fr*time-216deg)+epsI3-pi)"
        I_E = "Im1*cos(2*pi*fr*time-288deg+epsI1-pi) + Im3*cos(3*(2*pi*fr*time-288deg)+epsI3-pi)"
        m2d.assign_coil
